...
function Servo(opts) {
  ...
  // Treat this as a "zero" point, moves are made
  // relative to this position.
  this.zeroAt = opts.zeroAt || null;
...
Servo.prototype.to = function(degrees, time, rate) {
  ...
  // If a "zero" position exists, then the provided degrees
...
[{
  ...
  setup.apis.forEach(function(api) {
    Servo.prototype[api] = function(rate) {
      ...
      copy.unshift(rate);
      return this.to(__.scale.apply(null, copy));
    };
  });
});
